...
import DataGridTasks from "../components/DataGridTasks";
...
const TaskScreen = () => {
  ...
  const {loading:loadingUpdateTask}=useSelector(state=> state.taskUpdate)
  const {
  ...
  return (
    <MainLayout>
      {loadingUpdateTask && <CircularProgress />}
      <div className="table__unresponsive">
        ...
        {!loadingUpdateTask && <DataGridTasks
          cols={columns}
          rows={formatRowsData()}
